TITLE: YGGDRASIL TRAINING TRACK T8 / APPLICATION A17 — Bounded Incremental Developmental Patch Tracking
DATE: 2026-09-21
...
For each scenario,
A17 begins with the exact accepted A15 C-v2 prior
...
No primary patch target may exist before A17 freeze.

Let F17 be the exact A17 harness freeze commit.
...
prior_B;
C-v1;
any earlier effective prior in this A17 path.
...
Two complete deterministic A17 primary sweeps.
...
A17 asks whether Yggdrasil can handle smaller changes
...
So A17 tests the first bounded form of:
...
This experiment was originally preregistered under the A16 identifier
before any harness commit,
freeze,
primary manifest,
or observed result.

A separate T8 preregistration reached the A16 identifier first:

A16 — Hysteretic Working-State Plasticity Under Moving Developmental Drift.

To preserve both scientific questions without an identifier collision,
this bounded incremental patch-journal gate is continued unchanged as:

A17 — Bounded Incremental Developmental Patch Tracking.

Only identifiers,
freeze symbol F17,
post-freeze derivation tags,
and primary signal namespace were renumbered.
