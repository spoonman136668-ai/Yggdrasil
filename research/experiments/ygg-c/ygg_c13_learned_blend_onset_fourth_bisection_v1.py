...
PREREG="28ab76baf56fb51a0bfbf22847cbd1f6b122246e"
PARENT_CLOSURE="1b46add5bab664782399a82afc780e6999591340"
ALPHAS=(0.1328125,0.13671875,0.140625)
EXTENDED=(0.0,0.0625,0.125,0.1328125,0.13671875,0.140625,0.15625,0.1875,0.25,0.5,1.0)
ANCHOR_01328125="35a4341d528efdee8dd14320b132f1d01727987dcadb1c4cd3bd903a8d856a55"
ANCHOR_0140625="8e1d685d6eb4242ed271475002708c95773b1c1cda13622f42ac1739fd8f70ff"
...
def main():
    ...
    if old_alphas!=(0.0625,0.125,0.1875,0.25):
        raise SystemExit("YGG_C13_UNEXPECTED_C9_ALPHA_SET")
    if old_extended!=(0.0,0.0625,0.125,0.1875,0.25,0.5,1.0):
        raise SystemExit("YGG_C13_UNEXPECTED_C9_EXTENDED_SET")
    ...
    category=(
        ...
        else "ONSET_BETWEEN_013671875_AND_0140625"
    )
    ...
    validity={
        ...
        "alpha0140625_duplicate_anchor_exact":hi["duplicate_sha256"]==ANCHOR_0140625,
        "alpha01328125_interaction_false":not lo["interaction_driven"],
        "alpha0140625_interaction_true":bool(hi["interaction_driven"]),
        "alpha0140625_context_slots_exact_A_C":tuple(hi["context_dependent_slots"])==("A","C"),
    ...
    qualification={
        "YGG_C13_LEARNED_BLEND_ONSET_FOURTH_BISECTION":bool(
