...
PREREG="e242c491a690c83677fcd44a39a10db7027086bc"
PARENT_CLOSURE="a05b34d574d5c16d31bc33d9eb89e6e7640f2c8b"
ALPHAS=(0.125,0.1328125,0.140625)
EXTENDED=(0.0,0.0625,0.125,0.1328125,0.140625,0.15625,0.1875,0.25,0.5,1.0)
...
def main():
    ...
    if old_alphas!=(0.0625,0.125,0.1875,0.25):
        raise SystemExit("YGG_C12_UNEXPECTED_C9_ALPHA_SET")
    if old_extended!=(0.0,0.0625,0.125,0.1875,0.25,0.5,1.0):
        raise SystemExit("YGG_C12_UNEXPECTED_C9_EXTENDED_SET")
    ...
    category=(
        ...
        else "ONSET_BETWEEN_01328125_AND_0140625"
    )
    ...
    qualification={
        "YGG_C12_LEARNED_BLEND_ONSET_THIRD_BISECTION":bool(
