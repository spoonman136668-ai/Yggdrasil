...
PREREG="36b09c008efa7fd538f77be2a92e98642d887646"
...
def mechanical():
    ...
    checks={
        ...
        "value_dimension_exactly_2":model.value_emb.weight.shape==(VALUES,VALUE_DIM),
...
def one_pass():
    ...
    q={
        ...
        "state_exactly_24":all(r["persistent_state_scalars"]==PERSISTENT_SCALARS for r in rows),
        "parameter_count_exactly_104":all(r["parameter_count"]==PARAMETERS for r in rows),
    ...
    q["YGG_B13_TWO_FACTOR_STRUCTURAL_BINDING"]=all(q.values())
