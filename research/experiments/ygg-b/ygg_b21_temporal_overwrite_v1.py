...
PREREG="e05a915f6eec160c1a6bfc671b4349a4240afe13"
...
def one_pass():
    ...
    q["YGG_B21_TEMPORAL_OVERWRITE_SEQUENCE_INTELLIGENCE"]=all(q.values())
...
def main():
    ...
    if not mech["all_pass"]:
        raise SystemExit("YGG_B21_MECHANICAL_GATE_FAILED")
    p1=one_pass()
    p2=one_pass()
