TITLE: DG-1A-AR-S2 — Adaptive Causal Baseline Gating Audit
DATE: 2026-09-18
...
BRANCH: dg1a-ar
PARENT: dg1a-ars1-local-disturbance-subspace-poc.ice
...
ORTHOGONALIZED
AR-S1 action-responsive projection followed by local disturbance prediction.
