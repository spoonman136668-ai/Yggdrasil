TITLE: DG-1A-AR-C3 — Compressed Source-Independence / Context Confidence Audit
DATE: 2026-09-18
STATUS: SYNTHETIC / MEASURED_SANDBOX POSITIVE-BUT-BOUNDED PROVENANCE AUDIT
TRACK: DG-1A / ADAPTIVE-RULE RESEARCH
BRANCH: dg1a-ar
PARENT: dg1a-arc2-distributed-context-consensus-audit.ice

PURPOSE
AR-C2 showed that decentralized context consensus needs to distinguish:
...
The explicit 8-sensor table used in AR-C2 is an identifiability upper bound,
...
DECISION
AR-C3 is POSITIVE within the tested small-sensor regime.
