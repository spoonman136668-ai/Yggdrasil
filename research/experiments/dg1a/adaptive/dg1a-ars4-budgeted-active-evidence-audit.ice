TITLE: DG-1A-AR-S4 — Budgeted Active Evidence Collection Audit
DATE: 2026-09-18
...
BRANCH: dg1a-ar
PARENT: dg1a-ars3-confidence-weighted-plasticity-audit.ice

PURPOSE
AR-S3 showed that confidence-triggered evidence accumulation is much more robust than fixed one-pair consequence probing,
...
BENCHMARK
Same bounded one-dimensional local role-control task as AR-S3.
