TITLE: DG-1A-AR-S5 — Value-of-Information / Urgency Coupling Audit
DATE: 2026-09-18
...
BRANCH: dg1a-ar
PARENT: dg1a-ars4-budgeted-active-evidence-audit.ice

PURPOSE
AR-S4 established that causal evidence behaves like a finite local adaptive resource.
...
The AR-S4 token budget can be extended conceptually to:
