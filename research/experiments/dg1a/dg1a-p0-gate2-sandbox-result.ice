TITLE: DG-1A-P0 Gate 2 Sandbox Result — Calibrated 0.60 Lesion
DATE: 2026-09-17
...
QUESTION
Under the calibrated 0.60 center-lesion protocol, does maturity-gated regeneration outperform growth-only development across the preregistered five-seed matched family?
...
Allowed statement:
The P0 five-seed sandbox replication meets the preregistered numerical regeneration criterion under the calibrated 0.60 lesion.

Not yet allowed:
Yggdrasil has confirmatorily established H-P0-3.

DECISION
1. Keep the 0.60 lesion protocol frozen.
2. Preserve seed 2 as an invalid-lesion pair; do not lower the threshold.
3. Treat the growth-only full-grid expansion as a documented negative control behavior requiring no assertion weakening.
4. Proceed to commit-bound reproduction when an authorized execution path is available.
5. In parallel, exploratory full-size 40 x 40 P0 work may begin because the small substrate has replicated the intended qualitative mechanism, but full-size results remain exploratory until provenance/acceptance closes.
6. DG-1A-FIB1 remains blocked from altering P0 and will use P0 as a later scheduling control.
