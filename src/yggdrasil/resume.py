...
from .training import HOME_T16_PROBE_STEPS, TrainingConfig, TrainingSummary, _rng_neutral_homeostasis_probe, _rng_neutral_homeostasis_trajectory, attractor_trajectory_loss, training_morphology_loss
...
class ResumableTrainingSession:
    ...
    def _one_iteration(self) -> None:
        ...
        morph = training_morphology_loss(result=result, target=self.target_batch, config=self.config, homeostasis_loss=homeostasis_loss, attractor_loss=attractor_loss)
