...
def validate_config(config: dict[str, Any]) -> None:
    ...
    if training.get('loss_mode', 'global_mse') not in {'global_mse', 'balanced_fg_bg', 'global_plus_foreground', 'global_plus_foreground_bg_alpha', 'global_plus_foreground_bg_alive_margin', 'global_plus_foreground_farfield_bg_alpha'}:
